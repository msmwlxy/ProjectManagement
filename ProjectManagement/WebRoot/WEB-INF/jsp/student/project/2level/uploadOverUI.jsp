...
<body>	
	  <div class="right">
        ...
        <div id="prompt" >由于要将上传的word文件转换为swf文件，所以上传后的等待之间可能会稍长，请耐心等待</div>
        <div class="sanjiao">
        
       	<input type="hidden" id="projectId" value="${pp.projectId }"/>
     	  	<div class="upload" style="	margin-top:0px;"><font style="font-size: 16px">上传报告:</font>
        	<input type="file" name="upload" id="upload" style="margin:50px auto auto 0px;vertical-align:4px;"/>
          	<p style="margin:-30px -40px;"><input type="button" style="width:100px;margin:60px 400px;" value="确定" 
          	onclick="return jiaoyan('student/uploadOver','上传结项报告成功','student/uploadOverFUI','上传结项报告成功，即将返回......')"/>
           </p>
   </div>
