...
<body>	
	  <div class="right">
       ...
       <input type="hidden" id="projectId" value="${pp.projectId }"/>
     	  	<div class="upload" style="	margin-top:0px;"><font style="font-size: 16px">上传论文:</font>
        	<input type="file" name="upload" id="upload" style="margin:50px auto auto 0px;vertical-align:4px;"/>
          	...
          	onclick="return jiaoyan('student/uploadThesis','上传论文成功','student/uploadThesisFUI','上传论文成功，即将返回......')"/>
           </p>
   </div>
