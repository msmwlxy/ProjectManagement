...
<title>上传结项报告的父页面</title>
</head>
<body>
    <div class="right">
        <table width="800" border="0">
            <tr > 
                <td colspan="2"><img src="images/jiexiang.gif" width="21" height="17" style="margin-left:24px;"><span style="font-weight:bolder;">上传结项报告</span></td>
            </tr>
            ...
            <tr class="text_font">
                ...
                <td><a href="student/uploadOverUI?projectId=${project.projectId }" style="margin-left:-100px;">上传</a>&nbsp;<img src="images/2.png" height="10"></td>
            </tr>
