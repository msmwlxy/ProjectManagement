...
public class StudentServiceImp implements StudentService {
	...
	public QueryResult<Student> getQueryResult(Class<Student> StudentClass,
		...
		return studentDao.getQueryResult(StudentClass, startIndex, MaxResults,
				parameters, where, orderBy);
	}
	...
	public QueryResult<Student> getQueryResult(Class<Student> StudentClass,
			int startIndex, int MaxResults, Object[] parameters, String where) {
		return this.getQueryResult(StudentClass, startIndex, MaxResults,
	...
	public QueryResult<Student> getQueryResult(Class<Student> StudentClass,
		...
		return this.getQueryResult(StudentClass, startIndex, MaxResults, null,
				null, orderBy);
	}
	...
	public QueryResult<Student> getQueryResult(Class<Student> StudentClass,
		...
		return this.getQueryResult(StudentClass, -1, -1, parameters, where,
				orderBy);
	}
